...
class AmazonScraper(scrapy.Spider):
    ...
    def parse_speaker(self, response):
        ...
        yield Speaker(product_name = product_name.strip(), asin = asin, category = category , rating = rating.strip(), price = price.strip(), colour = colour.strip(), instock = instock, description = description, image_urls = [img_url])