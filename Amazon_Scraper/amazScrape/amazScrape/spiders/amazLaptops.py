...
class AmazonScraper(scrapy.Spider):
    ...
    def parse_laptop(self, response):
        ...
        yield Laptop(product_name = product_name.strip(), asin = asin, rating = rating.strip(), category = category, price = price.strip(), colour = colour.strip(), instock = instock, description = description, image_urls = [img_url])