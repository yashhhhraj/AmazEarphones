...
class AmazonScraper(scrapy.Spider):
    ...
    def parse_mobile(self, response):
        ...
        yield Mobile(title = title.strip(), asin = asin, rating = rating.strip(), price = price.strip(), colour = colour.strip(), instock = instock, description = description, image_urls = [img_url])